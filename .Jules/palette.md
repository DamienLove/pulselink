...
## 2024-05-29 - Hex Code Editing for Color Inputs
**Learning:** Native HTML color pickers are mouse-dependent and often hide hex codes, frustrating designers who want to copy-paste specific brand colors.
**Action:** Implemented a `ColorInput` component that syncs a visual picker with a text input, allowing both visual selection and precise hex entry.
