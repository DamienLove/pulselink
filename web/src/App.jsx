                  ...
                  <div className="settings-row">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      ...
                      <button
                        ...
                        title="Copy User ID"
                        aria-label={copyFeedback === 'uid' ? "Copied User ID" : "Copy User ID"}
                        style={{ padding: 0, height: 28, width: 28, display: 'flex', alignItems: 'center', justifyContent: 'center', border: 'none' }}
                      >
                        {copyFeedback === 'uid' ? <CheckIcon /> : <CopyIcon />}
                      </button>
                    </div>
                  </div>
