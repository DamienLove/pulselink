...
function App() {
  ...
  const [remoteSettings, setRemoteSettings] = useState(defaultRemoteSettings);
  ...
  useEffect(() => {
    ...
    if (user.uid === 'mock_user') {
      setPremiumClaimActive(true);
      setProClaimActive(true);
      return;
    }
            ...
            <div className="home-panel">
              ...
              <div className="home-grid">
                ...
                >
                  ...
                  <p>Add or remove features to customize your experience.</p>
                </button>
              </div>
            </div>
          )}
              ...
              {[
                {
                  title: "Core",
                  items: [
                    { id: 'beaconLauncherEnabled', name: 'Beacon Inbox', desc: 'SMS inbox synced from your phone. Separate launcher icon on Android.', icon: beaconLogo, isImg: true },
