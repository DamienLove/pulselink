...
const ThreadItem = memo(({ thread, isActive, onSelect, showPreviews, onPin, onArchive, displayName }) => {
  return (
    <div
      ...
      aria-label={`Select conversation with ${displayName}${showPreviews && thread.snippet ? `, ${thread.snippet}` : ''}`}
      onKeyDown={(e) => {
          ...
          <div className="thread-list">
            ...
            {isLoadingThreads ? (
              ...
              filteredThreads.map(thread => {
                ...
                const displayName = contact?.displayName || thread.display_name || thread.address;
