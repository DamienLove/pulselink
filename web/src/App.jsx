...
import { EXTENSIONS_LIST } from './data/extensions';
  ...
  return (
    <div className={`sidebar ${collapsed ? 'collapsed' : ''}`}>
      ...
      <div className="sidebar-nav">
        ...
        {remoteSettings.trustedContactsEnabled && (
          <button
...
function App() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(userRef, (snapshot) => {
      ...
      setRemoteSettings({
        ...
        trustedContactsEnabled: data.trustedContactsEnabled ?? true,
  ...
  const handleRemoteSettingsSave = async () => {
    ...
    try {
      await setDoc(doc(db, "users", user.uid), {
        ...
        beaconEnabled: remoteSettings.beaconEnabled,
        trustedContactsEnabled: remoteSettings.trustedContactsEnabled,
  ...
  const handleQuickSetup = async (mode) => {
    ...
    if (isEssentials) {
      ...
      newSettings.trustedContactsEnabled = true;
        ...
        <div className="main-content" id="main-content">
          ...
          {activePanel === 'extensions' && (
            <div className="pulselink-panel">
              ...
              {EXTENSIONS_LIST.map((category) => (
                <div key={category.category} className="extension-category" style={{marginBottom: 32}}>
                  <h4 style={{marginBottom: 16, color: 'var(--ink)'}}>{category.category}</h4>
                  <div className="home-grid">
                    {category.items.map(ext => {
                      ...
                      return (
                        <div className="home-card" key={ext.id} style={{ opacity: isLocked ? 0.6 : 1, position: 'relative' }}>
                          ...
                          <p style={{marginBottom: 16, minHeight: 40}}>{ext.description}</p>
