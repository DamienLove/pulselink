...
const defaultTheme = {
  ...
  onBubbleIncoming: "#f0f4f8",
  onBackground: "#f0f4f8",
  topBarColor: "#0a0c14",
  onTopBarColor: "#f0f4f8",
...
const buildThemeVars = (theme) => {
  ...
  const vars = {
    ...
    "--accent-light": active.secondaryColor,
    ...
    "--ink-muted": active.timestampColor ?? "#94a3b8",
    "--border": active.dividerColor ?? "rgba(255, 255, 255, 0.08)",
