...
@Singleton
class SmsCloudSync @Inject constructor(
    ...
    private fun hasSmsPermission(): Boolean {
        ...
        return perms.all { perm ->
            ContextCompat.checkSelfPermission(appContext, perm) == android.content.pm.PackageManager.PERMISSION_GRANTED
        }
    }
    ...
    companion object {
        private const val TAG = "SmsCloudSync"
    }
}
