...
import com.pulselink.ui.state.LoginViewModel_HiltModules;
...
public final class DaggerPulseLinkApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends PulseLinkApp_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(ImmutableMap.<String, Boolean>of(LazyClassKeyProvider.com_pulselink_ui_state_LoginViewModel, LoginViewModel_HiltModules.KeyModule.provide(), LazyClassKeyProvider.com_pulselink_ui_state_MainViewModel, MainViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      ...
      static String com_pulselink_ui_state_LoginViewModel = "com.pulselink.ui.state.LoginViewModel";

      @KeepFieldType
      MainViewModel com_pulselink_ui_state_MainViewModel2;

      @KeepFieldType
      LoginViewModel com_pulselink_ui_state_LoginViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends PulseLinkApp_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(ImmutableMap.<String, javax.inject.Provider<ViewModel>>of(LazyClassKeyProvider.com_pulselink_ui_state_LoginViewModel, ((Provider) loginViewModelProvider), LazyClassKeyProvider.com_pulselink_ui_state_MainViewModel, ((Provider) mainViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.pulselink.ui.state.LoginViewModel 
          return (T) new LoginViewModel(singletonCImpl.firebaseAuthManagerProvider.get());

          case 1: // com.pulselink.ui.state.MainViewModel 
