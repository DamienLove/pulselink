...
package com.pulselink.databinding;
...
public final class NativeAdViewBinding implements ViewBinding {
  ...
  private NativeAdViewBinding(@NonNull NativeAdView rootView, @NonNull ImageView adAppIcon,
      @NonNull TextView adBody, @NonNull Button adCallToAction, @NonNull TextView adHeadline,
      @NonNull MediaView adMedia, @NonNull RatingBar adStars) {
  ...
  @NonNull
  public static NativeAdViewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NativeAdViewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.native_ad_view, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NativeAdViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NativeAdViewBinding((NativeAdView) rootView, adAppIcon, adBody, adCallToAction,
          adHeadline, adMedia, adStars);
    }
