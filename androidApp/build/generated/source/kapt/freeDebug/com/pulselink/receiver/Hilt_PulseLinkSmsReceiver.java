...
public abstract class Hilt_PulseLinkSmsReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((PulseLinkSmsReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectPulseLinkSmsReceiver(UnsafeCasts.<PulseLinkSmsReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
