...
public abstract class Hilt_SmsSendReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((SmsSendReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectSmsSendReceiver(UnsafeCasts.<SmsSendReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
