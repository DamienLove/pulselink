...
public final class AlertDispatcher_Factory implements Factory<AlertDispatcher> {
  ...
  public AlertDispatcher get() {
    return newInstance(contextProvider.get(), smsSenderProvider.get(), locationProvider.get(), registrarProvider.get(), soundCatalogProvider.get(), audioOverrideManagerProvider.get());
  }
  ...
  public static AlertDispatcher_Factory create(Provider<Context> contextProvider,
      ...
      Provider<SoundCatalog> soundCatalogProvider,
      Provider<AudioOverrideManager> audioOverrideManagerProvider) {
    return new AlertDispatcher_Factory(contextProvider, smsSenderProvider, locationProvider, registrarProvider, soundCatalogProvider, audioOverrideManagerProvider);
  }

  public static AlertDispatcher newInstance(Context context, SmsSender smsSender,
    ...
    return new AlertDispatcher(context, smsSender, locationProvider, registrar, soundCatalog, audioOverrideManager);
  }
}
