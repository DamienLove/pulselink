...
final class InMemoryConversationProvider: ConversationProvider {
    ...
    init(seed: [ContactCard: [ConversationMessage]] = [:]) {
        ...
        if seed.isEmpty {
            let c1 = ContactCard(threadId: "1", lineId: nil, name: "Alex Rivera", address: "5551234567", role: "Friend", presence: .online, unread: 2, isFavorite: true, isPrivate: false, isTrusted: false)
            let c2 = ContactCard(threadId: "2", lineId: nil, name: "Morgan Lee", address: "5559876543", role: "Family", presence: .recent, unread: 0, isFavorite: false, isPrivate: true, isTrusted: true)
            store = [
                c1: [],
                c2: []
            ]
